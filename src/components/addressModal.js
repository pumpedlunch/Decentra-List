              ...
              <Dialog.Panel className="w-10/12 max-w-md transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
                <div className="text-lg font-semibold tracking-tight text-gray-800">
                  ...
                  <div className="px-8 py-4 flex items-center gap-3">
                    ...
                    >
                      <path
                        style={{ fill: "#3E3A45", fillOpacity: "1" }}
                        d="m 55,25 -4,0 c -2,8 -3,9 -11,10 l 0,5 10,0 0,36 5,0 0,-51"
                      />
                      <ellipse
                        cx="50"
                        cy="50"
                  ...
                  <div className="text-left px-6">
                    <button
                      className="rounded-md border border-transparent bg-[#ace4aa] mb-4 px-6 py-3 text-base font-medium text-gray-800 shadow-md hover:bg-[#9AD398] hover:text-black focus:outline-none focus:ring-2 focus:ring-[#9AD398] focus:ring-offset-2 ml-3"
                      type="button"
                  ...
                  <div className="text-left px-6">
                    <div className="ml-2">
                      <textarea
                        ...
                        className="border-2 border-gray-300 w-96 p-4 mb-4"
                      ></textarea>
                    </div>
                    <button
                      className="mb-10 rounded-md border border-transparent bg-[#ace4aa] px-6 py-3 text-base font-medium text-gray-800 shadow-md hover:bg-[#9AD398] hover:text-black focus:outline-none focus:ring-2 focus:ring-[#9AD398] focus:ring-offset-2 ml-3"
                      type="button"
